...
A summary of terms relating to rock magnetism and sea floor spreading [here](http://www3.geosc.psu.edu/~jte2/geosc20/lect26.html).
...
#### Magnetosphere
There is a secondary system that creates a magnetosphere to engulf the craft which creates a stable environment of non inertia forces. This also protects the occupants from protons and radiation exposure and events.

#### What the craft look like

ET craft look like a ball of light at night because the high energy source from the craft interact with our gas atmosphere (oxygen, nitrogen). Applying enough energy to gas molecules, emit photons (light). The light emitted from them is a plasma residue from powering up.
